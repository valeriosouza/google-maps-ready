               ...
               <div class='gmpFormRow'>
                   <?php
                    ...
                    echo htmlGmp::colorpicker("border_color",
                                            array(
                                            'attrs' =>  " class='gmpInputSmall' id='gmpNewMap_border_color' ",
                                             'value'    =>" ",   
...
//				array('teeny'=>true,'quicktags' => false) );
                   ...
                   <div class='gmpIconsList'>
                     <?php
                        foreach($this->marker_opts['icons'] as $icon){
                           ...
                           ?>
                               <a class='markerIconItem' data_name='<?php echo $icon['title'];?>' data_desc="<?php echo $icon['description']; ?>" title='<?php echo $icon['title'];?>' data_val='<?php echo $icon['id'];?>'>
                    ...
                    <input type="hidden" name="marker_opts[icon]" value="" id="gmpSelectedIcon" class="right">
