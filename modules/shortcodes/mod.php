    ...
    protected $_codes = array(
        /*'category' => array(
			...
			'atts' => array(
				...
				'catalog_view' => array('label' => 'Catalog Items view', 'type' => 'selectbox', 'params' => array('optionsGmp' => array('grid' => 'Grid View', 'list' => 'List View'))),
				...
				'show' => array('label' => 'Show params', 'type' => 'selectlist', 'params' => array('optionsGmp' => array('shadow_border' => 'Shadow border on product item hover', 'short_descr_hide' => 'Short description', 'catalog_image' => 'Product Image', 'title' => 'Product Title', 'price' => 'Price', 'more' => 'Read More', 'add_to_cart' => 'Add to Cart'))), 
				'exclude' => array('label' => 'Exclude params', 'type' => 'selectlist', 'params' => array('optionsGmp' => array('shadow_border' => 'Shadow border on product item hover', 'short_descr_hide' => 'Short description', 'catalog_image' => 'Product Image', 'title' => 'Product Title', 'price' => 'Price', 'more' => 'Read More', 'add_to_cart' => 'Add to Cart'))),
			), 
			'tpl' => '[%code%%atts%]'),*/
    );
}